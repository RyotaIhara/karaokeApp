...
@section('content')
  ...
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete" data-whatever="{{$scene->id}}">削除</button>
  ...
  <script>
    ...
    $('#confirm-delete').on('show.bs.modal', function (event) {
      ...
      target.href = "/scene/" + String(delete_id) + "/logicDelete"
